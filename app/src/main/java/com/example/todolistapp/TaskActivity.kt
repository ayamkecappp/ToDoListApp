...
class TaskActivity : AppCompatActivity() {
    ...
    private val KEY_STREAK_START_DATE = "streak_start_date" // <-- TAMBAHKAN INI
            ...
            if (daysBetween > 1) {
                ...
                for (i in 1 until daysBetween) {
                    ...
                    if (tasksOnDay.isNotEmpty() && completedOnDay.isEmpty()) {
                        ...
                        prefs.edit()
                            .putInt(KEY_STREAK, 0)
                            .remove(KEY_STREAK_START_DATE) // ✅ HAPUS TANGGAL MULAI
                            .apply()
    ...
    private fun updateStreakOnCompletion() {
        ...
        if (lastCompletionDateStr != todayStr) {
            ...
            if (isStreakContinued) {
                ...
                // ✅ SIMPAN TANGGAL MULAI STREAK BARU
                prefs.edit().putString(KEY_STREAK_START_DATE, todayStr).apply()
            }
